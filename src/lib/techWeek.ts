...
export const techWeekPackages: TechWeekPackage[] = [
  ...
  },
  {
    ...
    description:
      'Everything in Next Morning, plus 5 vertical cutdowns for Reels, TikTok and LinkedIn, captioned and ready within 5 business days.',
    startingPrice: 5500,
  },
  {
    id: 'full-week',
    ...
    description:
      'Up to 4 events across October 5 to 11, one crew per event. Teaser and vertical clip by 10am daily, one week recap film, shared folder.',
    startingPrice: 18000,
  },
]
