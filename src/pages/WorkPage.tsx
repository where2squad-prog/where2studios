...
const CATEGORIES = ['all', 'corporate', 'events', 'weddings', 'commercials', 'social']
...
export default function WorkPage() {
  ...
  return (
    <div className="min-h-screen bg-m3-surface-variant">
      ...
      {/* Filters and Sort */}
      <section className="sticky top-20 sm:top-24 z-50 bg-m3-surface-variant/95 backdrop-blur-sm border-b border-m3-outline py-4">
        <div className="container mx-auto px-4 sm:px-8 lg:px-12">
