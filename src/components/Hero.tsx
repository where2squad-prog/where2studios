      ...
      >
        <div className="max-w-3xl">
          <h1 className="font-fredoka font-semibold leading-[0.95] text-white drop-shadow-lg">
            <span className="block text-3xl sm:text-4xl lg:text-5xl xl:text-6xl tracking-tight">Stories That</span>
            <span className="block text-6xl sm:text-7xl lg:text-8xl xl:text-9xl text-golden-yellow font-bold tracking-tight">SCALE.</span>
          </h1>
