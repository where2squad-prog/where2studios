    ...
    <div className="relative h-screen w-full overflow-hidden bg-near-black">
      ...
      >
        <div className="max-w-3xl">
          <h1 className="font-fredoka font-semibold leading-[0.9] text-white drop-shadow-lg">
            <span className="block text-3xl sm:text-4xl lg:text-5xl xl:text-5xl tracking-normal">Stories That</span>
            <span className="block text-5xl sm:text-6xl lg:text-7xl xl:text-7xl text-golden-yellow font-bold tracking-normal">SCALE.</span>
          </h1>
