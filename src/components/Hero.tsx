        ...
        >
          <div className="flex items-center justify-between">
            ...
            <motion.div
              ...
              whileHover={{ scale: isScrolled ? 0.9 : 1.05 }}
              className="flex items-center cursor-pointer origin-left"
              onClick={() => {
                window.scrollTo({ top: 0, behavior: 'smooth' })
              }}
            >
              <img src={logo} alt="Where2Studios" className="h-20 sm:h-24 lg:h-36 w-auto drop-shadow-2xl" />
            </motion.div>
            ...
            <div className="flex items-center space-x-2 sm:space-x-3 relative">
              ...
              <motion.button
                ...
                className="bg-golden-yellow text-near-black font-fredoka font-semibold text-xs sm:text-sm px-4 sm:px-5 lg:px-6 py-2 sm:py-2.5 lg:py-3 rounded-full hover:bg-orange-accent gentle-animation cursor-pointer shadow-lg"
              >
                Book a Call
              </motion.button>
