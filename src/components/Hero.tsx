      ...
      >
        <div className="max-w-3xl">
          <h1 className="font-fredoka font-semibold leading-[1.05] text-white drop-shadow-lg">
            <span className="block text-4xl sm:text-5xl lg:text-6xl xl:text-7xl tracking-tight">Stories That</span>
            <span className="block text-4xl sm:text-5xl lg:text-6xl xl:text-7xl text-golden-yellow tracking-[0.15em]">SCALE.</span>
          </h1>
