...
export function HeroSection({
  ...
  return <div className="relative min-h-screen w-full overflow-hidden bg-m3-surface-dark">
      ...
      <div className="relative z-40 min-h-screen flex items-center">
        <div className="container mx-auto px-4 sm:px-8 lg:px-12 py-32">
          ...
          ease: [0.16, 1, 0.3, 1]
            ...
            {/* CTA Buttons */}
            {showCTAs && <div className="flex flex-col sm:flex-row gap-4">
                <Link to="/contact" className="m3-filled-button text-center">
                  Book a Discovery Call
                </Link>
                <Link to="/work" className="m3-outlined-button text-m3-on-dark border-m3-on-dark/30 hover:bg-m3-on-dark/10 text-center">
                  View Featured Work
                </Link>
              </div>}
          </motion.div>
      ...
      duration: 1,
      delay: 1
    }} className="absolute bottom-8 left-4 right-4 sm:left-8 sm:right-8 lg:left-auto lg:right-16 lg:w-auto z-40" ref={views.ref}>
