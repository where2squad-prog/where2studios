        ...
        <div className="container mx-auto px-4 sm:px-8 lg:px-12 py-12 sm:py-16 md:py-24 lg:py-32">
          <motion.div
            ...
            <p id="answer" className="text-sm sm:text-base md:text-lg text-white/75 max-w-md sm:max-w-lg md:max-w-2xl leading-snug sm:leading-relaxed md:leading-relaxed mb-4 sm:mb-6 md:mb-8">
              Experience hubs, lounges, off site HQs and side events near Moscone. Cloudflare and Claroty at RSA Conference, Google's Pixel House, Immuta at Snowflake Summit. Clips by 10am the next day.
            </p>
